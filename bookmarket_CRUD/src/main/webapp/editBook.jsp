	...
	<div class="row aligh-items-md-stretch">
		...
		<div class="col-md-4">
			<div class="h-100 p-2 round-3">
				<img src="/bookmarket_CRUD/resources/images/<%=book.getFilename()%>" style="width:250px; height:350px" />
				...
				<p>	
					<%
						...
						{
					%>
							<a href="updateBook?id=<%= book.getBookId() %>" class="btn btn-success" role="button">수정 &raquo;</a>
					<% 
						}
					...
					%>
							<a href="#" class="btn btn-danger" role="button" onclick="deleteConfirm('<%= book.getBookId() %>')" role="button">삭제 &raquo;</a>
					<%
						}
					%>
				</p>
