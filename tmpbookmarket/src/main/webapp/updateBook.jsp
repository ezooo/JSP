...
<div class="container py-4">
	...
	<div class="row align-items-md-stretch">
		...
		<!-- 이미지 파일이 섞이게 되면서 멀티파트 사용하도록 바뀜 -->
			<div class="mb-3 row">
				<div class="col-sm-3">
					<b>도서코드</b> : <input type="text" name="bookId" class="form-control" value="<%=book.getBookId()%>" readonly>
					<!-- 유효성 검사 함수와 연결하기 위해 아이디 설정 -->
				</div>
			</div>
			<div class="mb-3 row">
				<div class="col-sm-3">
					<b>도서명</b> : <input type="text" name="name" class="form-control" value="<%=book.getName()%>">
				</div>
			</div>
			<div class="mb-3 row">
				<div class="col-sm-3">
					<b>가격</b> : <input type="text" name="unitPrice" class="form-control" value="<%=book.getUnitPrice()%>">
				</div>
			</div>
			<div class="mb-3 row">
				<div class="col-sm-3">
					<b>저자</b> : <input type="text" name="author" class="form-control" value="<%=book.getAuthor()%>">
				</div>
			</div>
			<div class="mb-3 row">
				<div class="col-sm-3">
					<b>출판사</b> : <input type="text" name="publisher" class="form-control" value="<%=book.getPublisher()%>">
				</div>
			</div>
			<div class="mb-3 row">
				<div class="col-sm-3">
					<b>출판일</b> : <input type="text" name="releaseDate" class="form-control" value="<%=book.getReleaseDate() %>">
				</div>
			</div>
			<div class="mb-3 row">
				<div class="col-sm-3">
					<textarea name="description" cols="100" rows="3" class="form-control"><%=book.getDescription()%></textarea>
				</div>
			</div>
			<div class="mb-3 row">
				<div class="col-sm-3">
					<b>카테고리</b> : <input type="text" name="category" class="form-control" value="<%=book.getCategory()%>">
				</div>
			</div>
			<div class="mb-3 row">
				<div class="col-sm-3">
					<b>재고 수</b> : <input type="text" name="unitsInStock" class="form-control" value="<%=book.getUnitsInStock() %>">
				</div>
			</div>
			<div class="mb-3 row">
				<div class="col-sm-5">
